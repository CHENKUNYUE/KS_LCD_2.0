 ...
 * @return
 */
void protocol_1363_init_paras(void) { protocol_1363_set_hw_paras(&protocol1363_init_paras); }
 ...
 * @return
 */
void protocol_1363_get_hw_addr(uint8_t *addr) { *addr = PROTOCOL1363_LCD_ADDR; /*(uint8_t) bms.bms_addr; */ }
...
void protocol_1363_set_hw_paras(protocol1363_init_paras_struct *protocol1363_init_paras) {
    ...
    protocol1363_init_paras->machine_addr = PROTOCOL1363_LCD_ADDR; // bms.bms_addr;
...
uint8_t protocol_1363_S2M_send_data_time_4E(data_time_typedef *data_time_ptr) {
    ...
    if ((data_time_ptr->year < 2100) && (data_time_ptr->month < 13) && (data_time_ptr->day < 32) && (data_time_ptr->hour < 25)
...
void protocol_1363_get_slave_para_42(sys_status_typedef *sys_status_ptr) {
    ...
    PackData.Alarm_State.BitName.bCellVoltOV =
        sys_status_ptr->V_status_list.bit.cell_OVV_alarm | sys_status_ptr->V_status_list.bit.TOT_OVV_alarm;
    PackData.Alarm_State.BitName.bCellVoltUL =
        sys_status_ptr->V_status_list.bit.cell_UNDV_alarm | sys_status_ptr->V_status_list.bit.TOT_UNDV_alarm;
    PackData.Alarm_State.BitName.bTempOV =
        sys_status_ptr->TEMP_status_list.bit.CHG_H_TEMP_alarm | sys_status_ptr->TEMP_status_list.bit.DISCH_H_TEMP_alarm
        | sys_status_ptr->TEMP_status_list.bit.ENV_H_TEMP_alarm | sys_status_ptr->TEMP_status_list.bit.power_H_TEMP_alarm;
    PackData.Alarm_State.BitName.bTempUL =
        sys_status_ptr->TEMP_status_list.bit.CHG_L_TEMP_alarm | sys_status_ptr->TEMP_status_list.bit.DISCH_L_TEMP_alarm
        | sys_status_ptr->TEMP_status_list.bit.ENV_L_TEMP_alarm | sys_status_ptr->TEMP_status_list.bit.power_L_TEMP_alarm;

    PackData.Alarm_State.BitName.bSocUL = sys_status_ptr->warning_status_list.bit.low_BAT_alarm;

    PackData.Alarm_State.BitName.bVDiffOV = sys_status_ptr->V_status_list.bit.V_DIF_alarm;
    PackData.Alarm_State.BitName.bCurrOV  = sys_status_ptr->C_status_list.bit.DISCH_C_alarm | sys_status_ptr->C_status_list.bit.CHG_C_alarm;

    //保护
    PackData.Prp_State.BitName.bCellVoltOV =
        sys_status_ptr->V_status_list.bit.cell_OVV_PROT | sys_status_ptr->V_status_list.bit.TOT_OVV_PROT;
    PackData.Prp_State.BitName.bCellVoltUL =
        sys_status_ptr->V_status_list.bit.cell_UNDV_PROT | sys_status_ptr->V_status_list.bit.TOT_UNDV_PROT;

    PackData.Prp_State.BitName.bTempOV =
        sys_status_ptr->TEMP_status_list.bit.CHG_H_TEMP_PROT | sys_status_ptr->TEMP_status_list.bit.DISCH_H_TEMP_PROT
        | sys_status_ptr->TEMP_status_list.bit.ENV_H_TEMP_PROT | sys_status_ptr->TEMP_status_list.bit.power_H_TEMP_PROT;
    PackData.Prp_State.BitName.bTempUL =
        sys_status_ptr->TEMP_status_list.bit.CHG_L_TEMP_PROT | sys_status_ptr->TEMP_status_list.bit.DISCH_L_TEMP_PROT
        | sys_status_ptr->TEMP_status_list.bit.CHG_L_TEMP_PROT | sys_status_ptr->TEMP_status_list.bit.power_L_TEMP_PROT;

    PackData.Prp_State.BitName.bCurrOV = sys_status_ptr->C_status_list.bit.CHG_OC_PROT | sys_status_ptr->C_status_list.bit.DISCH_OC_1_PROT
                                       | sys_status_ptr->C_status_list.bit.DISCH_OC_2_PROT;
    PackData.Prp_State.BitName.bShortFault = sys_status_ptr->C_status_list.bit.Short_circuit_PROT;
    PackData.Prp_State.BitName.bNeg        = 0;

    /*故障*/
    PackData.Prp_State.BitName.bSmpErr    = sys_status_ptr->warning_status_list.bit.cell_fail;
    PackData.Prp_State.BitName.bChgMosErr = sys_status_ptr->warning_status_list.bit.CHG_MOS_fail;   //充电MOS故障
    PackData.Prp_State.BitName.bDisMosErr = sys_status_ptr->warning_status_list.bit.DISCH_MOS_fail; //放电MOS故障
    PackData.Prp_State.BitName.bChipSmpErr = sys_status_ptr->FET_status_list.bit.AFE_chip_fail; //AFE故障，单节电压超（3.9V）搞或超低
