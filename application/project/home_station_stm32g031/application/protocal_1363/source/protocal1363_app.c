...
protocol_id_params const protocol_rtn_group_info[] = {
    ...
    {0x52, &protocol_52_respond},          // 获取设备 (SM) 厂家信息
    ...
    {0xB0, &protocol_B0_respond}, // 参数设置 协议选择 B0H
    {0x00, &protocol1363_Null}    // 结束行-不动
};
...
void protocol_parallel_S2M_get_sys_int_params(void *ptr) {
    ...
    const PROTOCOL_S2M_VAR_TYPEDEF s_protocol1363_get_sys_status[] = {
        ...
        {&s_sys_status.cell_list[0], enum_data_var_u16, &s_sys_status.num_of_cells}, // 4
        ...
        {&s_sys_status.TEMP_list[0], enum_data_var_u16, &s_sys_status.TOT_TEMPs}, //
    ...
    protocol_parallel_para_var_set(s_comm_struct, s_protocol1363_get_sys_status, 17);
...
void protocol_parallel_S2M_get_time(void *ptr) {
    ...
    protocol1363_set_handler_cid2_new(ss_comm_struct, s_protocol1363_sys_data_time, 13);
...
void protocol_app_S2M_get_sm_code(void *ptr) {
    ...
    protocol_var_typedef s_protocol1363_sm_info[] = {
        {&g_sm_info.Hardware_type[0], enum_data_var_u8, 10}, {&g_sm_info.Product_code[0], enum_data_var_u8, 10},
        {&g_sm_info.Project_code[0], enum_data_var_u8, 10},  {&g_sm_info.Software_Ver[0], enum_data_var_u8, 3},
        {&g_sm_info.BOOT_Ver[0], enum_data_var_u8, 2},       {0, enum_data_var_end, 0}, // 14
    };
